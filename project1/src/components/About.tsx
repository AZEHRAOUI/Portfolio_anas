...
export const About = () => {
  ...
  return (
    <section id="about" className={`py-20 relative ${theme === 'dark' ? 'bg-background-dark' : 'bg-gray-50 animate-bgPulse'}`}>
      <div className="container mx-auto px-4">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className={`${theme === 'dark' ? 'bg-background-light/30 backdrop-blur-md border-primary/20 shadow-lg' : 'bg-white shadow-xl border-gray-200'} rounded-2xl p-6 border transform transition-all duration-300 hover:scale-105 hover:shadow-2xl`}
          >
            <div className="flex items-center gap-4 mb-6">
              <div className={`p-3 rounded-lg ${theme === 'dark' ? 'bg-primary/10' : 'bg-primary/5'}`}>
                <GraduationCap className="w-6 h-6 text-primary transition-transform duration-300 ease-in-out hover:scale-110" />
              </div>
              <h4 className={`text-lg font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{t('about.education.title')}</h4>
            </div>
            <p className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} leading-relaxed`}>
              {t('about.education.degree1')}<br />
              <span className="text-primary">{t('about.education.school1')}</span>
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              <div className={`p-3 rounded-lg ${theme === 'dark' ? 'bg-primary/10' : 'bg-primary/5'}`}>
                <Cpu className="w-6 h-6 text-primary transition-transform duration-300 ease-in-out hover:scale-110" />
              </div>
              <h4 className={`text-lg font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{t('about.specialization.title')}</h4>
            </div>
            <ul className={`space-y-2 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
              <li className="flex items-center gap-2">
                <span className="text-primary">•</span>
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              <div className={`p-3 rounded-lg ${theme === 'dark' ? 'bg-primary/10' : 'bg-primary/5'}`}>
                <Globe2 className="w-6 h-6 text-primary transition-transform duration-300 ease-in-out hover:scale-110" />
              </div>
              <h4 className={`text-lg font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{t('about.languages.title')}</h4>
            </div>
            <div className="space-y-4">
              {[{ lang: t('about.languages.french'), level: t('about.languages.native'), percent: 100 },
                { lang: t('about.languages.english'), level: t('about.languages.fluent'), percent: 90 },
                { lang: t('about.languages.german'), level: t('about.languages.intermediate'), percent: 70 }].map((lang, index) => (
                <div key={index} className="space-y-2">
                  <div className="flex justify-between">
                    <span className={theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}>
                      {lang.lang}
