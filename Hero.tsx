...
//           className="absolute w-[800px] h-[800px] border-2 border-primary/20 rounded-full"
//         />
//         <motion.div
//           animate={{ rotate: -360 }}
//           transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
//           className="absolute w-[600px] h-[600px] border-2 border-accent/20 rounded-full"
//         />
//       </div>
...
//               Passionné par le développement de solutions embarquées innovantes, 
//               spécialisé dans l'IoT et les systèmes électroniques avancés.
//             </p>
...
//                 className="absolute -right-4 top-10 bg-background-light p-3 rounded-full shadow-lg"
//               >
...
//                 className="absolute -left-4 bottom-20 bg-background-light p-3 rounded-full shadow-lg"
//               >
...
import { motion } from 'framer-motion';
import { Download, ChevronRight, CircuitBoard, Cpu, Microwave as Microchip } from 'lucide-react';
import { useTheme } from '../context/ThemeContext'; // Assurez-vous que le hook useTheme est correctement importé
